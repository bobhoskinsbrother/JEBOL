...
class ConversionFamilyTest {
    ...
    @Test
    @DisplayName("each one's title names the type it converts to")
    void theTitleNamesTheTargetType() {
        assertThat(answerTo("first spec-of :to-tuple"))
                .isEqualTo("\"Converts to tuple! value.\"");
        assertThat(answerTo("first spec-of :to-binary"))
                .isEqualTo("\"Converts to binary! value.\"");
    }

    @Test
    @DisplayName("each one takes exactly one argument")
    void theyTakeOneArgument() {
        assertThat(answerTo("mold next spec-of :to-tuple")).isEqualTo("\"[value]\"");
