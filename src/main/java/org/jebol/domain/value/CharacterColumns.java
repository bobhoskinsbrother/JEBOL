...
/**
 * The display column count of a character, ported from {@code UTF8_Width}
 * in {@code s-unicode.c}: control characters and combining marks take no
 * column, the East-Asian wide set takes two, and the rest take one. The
 * range tables are the C's, copied verbatim.
 */
public final class CharacterColumns {
    ...
    public static int widthOf(int codepoint) {
        ...
        if (codepoint <= 0xFFFF) {
            if (inRanges(ZERO_NARROW, codepoint)) {
                return 0;
            }
            if (inRanges(WIDE_NARROW, codepoint)) {
                return 2;
            }
        } else {
            if (inRanges(ZERO_SUPPLEMENTARY, codepoint)) {
                return 0;
            }
            if (inRanges(WIDE_SUPPLEMENTARY, codepoint)) {
                return 2;
            }
        }
        return 1;
    ...
    /** The UTF-8 byte count, {@code UTF8_Codepoint_Size} in the C. */
    public static int utf8SizeOf(int codepoint) {
        if (codepoint < 0x80) {
            return 1;
        }
        if (codepoint < 0x800) {
    ...
    private static boolean inRanges(int[][] ranges, int codepoint) {
        ...
        while (low <= high) {
            ...
            if (codepoint < ranges[middle][0]) {
                high = middle - 1;
            } else if (codepoint > ranges[middle][1]) {
                low = middle + 1;
            } else {
                return true;
            }
    ...
    private static final int[][] ZERO_NARROW = {
        ...
        {0x0859, 0x085B}, {0x0890, 0x089F}, {0x08CA, 0x0902}, {0x093A, 0x093A},
        {0x093C, 0x093C}, {0x0941, 0x0948}, {0x094D, 0x094D}, {0x0951, 0x0957},
        {0x0962, 0x0963}, {0x0981, 0x0981}, {0x09BC, 0x09BC}, {0x09C1, 0x09C4},
        {0x09CD, 0x09CD}, {0x09E2, 0x09E3}, {0x09FE, 0x0A02}, {0x0A3C, 0x0A3C},
        {0x0A41, 0x0A51}, {0x0A70, 0x0A71}, {0x0A75, 0x0A75}, {0x0A81, 0x0A82},
        {0x0ABC, 0x0ABC}, {0x0AC1, 0x0AC8}, {0x0ACD, 0x0ACD}, {0x0AE2, 0x0AE3},
        {0x0AFA, 0x0B01}, {0x0B3C, 0x0B3C}, {0x0B3F, 0x0B3F}, {0x0B41, 0x0B44},
        {0x0B4D, 0x0B56}, {0x0B62, 0x0B63}, {0x0B82, 0x0B82}, {0x0BC0, 0x0BC0},
        {0x0BCD, 0x0BCD}, {0x0C00, 0x0C00}, {0x0C04, 0x0C04}, {0x0C3C, 0x0C3C},
        {0x0C3E, 0x0C40}, {0x0C46, 0x0C56}, {0x0C62, 0x0C63}, {0x0C81, 0x0C81},
        ...
        {0x0DD2, 0x0DD6}, {0x0E31, 0x0E31}, {0x0E34, 0x0E3A}, {0x0E47, 0x0E4E},
        ...
        {0x1A17, 0x1A18}, {0x1A1B, 0x1A1B}, {0x1A56, 0x1A56}, {0x1A58, 0x1A60},
        {0x1A62, 0x1A62}, {0x1A65, 0x1A6C}, {0x1A73, 0x1A7F}, {0x1AB0, 0x1B03},
        ...
        {0x2060, 0x206F}, {0x20D0, 0x20F0}, {0x2CEF, 0x2CF1}, {0x2D7F, 0x2D7F},
    ...
    private static final int[][] ZERO_SUPPLEMENTARY = {
        ...
        {0x110B9, 0x110BA}, {0x110BD, 0x110BD}, {0x110C2, 0x110CD},
        ...
        {0x11366, 0x11374}, {0x113BB, 0x113C0}, {0x113CE, 0x113CE},
        ...
        {0x11943, 0x11943}, {0x119D4, 0x119DB}, {0x119E0, 0x119E0},
        ...
        {0x11B62, 0x11B64}, {0x11B66, 0x11B66}, {0x11C30, 0x11C3D},
        {0x11C3F, 0x11C3F}, {0x11C92, 0x11CA7}, {0x11CAA, 0x11CB0},
        {0x11CB2, 0x11CB3}, {0x11CB5, 0x11CB6}, {0x11D31, 0x11D45},
        ...
        {0x1CF00, 0x1CF46}, {0x1D167, 0x1D169}, {0x1D173, 0x1D182},
        {0x1D185, 0x1D18B}, {0x1D1AA, 0x1D1AD}, {0x1D242, 0x1D244},
        {0x1DA00, 0x1DA36}, {0x1DA3B, 0x1DA6C}, {0x1DA75, 0x1DA75},
        {0x1DA84, 0x1DA84}, {0x1DA9B, 0x1DAAF}, {0x1E000, 0x1E02A},
    ...
    private static final int[][] WIDE_NARROW = {
        ...
        {0x2B55, 0x2B55}, {0x2E80, 0x2FFF}, {0x3001, 0x303E}, {0x3041, 0x3247},
        {0x3250, 0xA4C6}, {0xA960, 0xA97C}, {0xAC00, 0xD7A3}, {0xF900, 0xFAFF},
        {0xFE10, 0xFE19}, {0xFE30, 0xFE6B},
    };

    private static final int[][] WIDE_SUPPLEMENTARY = {
        {0x16FE0, 0x1B2FB}, {0x1D300, 0x1D376}, {0x1F004, 0x1F004},
        ...
        {0x1F7E0, 0x1F7F0}, {0x1F90C, 0x1F93A}, {0x1F93C, 0x1F945},
        {0x1F947, 0x1F9FF}, {0x1FA70, 0x1FAF8}, {0x20000, 0x3FFFD},
    };
}
