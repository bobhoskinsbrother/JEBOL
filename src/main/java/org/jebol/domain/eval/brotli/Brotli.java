 ...
 * refinement is for.
 *
 * <p>The only way in to this package. Everything else in it is package-private,
 * because the format's insides -- hashers, cost models, block splitters -- are
 * of no use to a caller and change shape whenever the port learns something.
 */
